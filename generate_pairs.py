...
# Top currency pairs by search volume - 100+ pairs
PAIRS = [
    # Tier 1 - Highest volume (USD base)
    ...
    ('GBP', 'AED', 'British Pound', 'UAE Dirham'),
    # AUD/NZD pairs
    ...
    ('AUD', 'INR', 'Australian Dollar', 'Indian Rupee'),
    ...
    ('SGD', 'INR', 'Singapore Dollar', 'Indian Rupee'),
    # Asian currencies
    ('CNY', 'JPY', 'Chinese Yuan', 'Japanese Yen'),
    ('KRW', 'USD', 'South Korean Won', 'US Dollar'),
    ('KRW', 'JPY', 'South Korean Won', 'Japanese Yen'),
    ...
    ('VND', 'USD', 'Vietnamese Dong', 'US Dollar'),
    # Middle East
    ('AED', 'USD', 'UAE Dirham', 'US Dollar'),
    ('AED', 'INR', 'UAE Dirham', 'Indian Rupee'),
    ('SAR', 'USD', 'Saudi Riyal', 'US Dollar'),
    ('SAR', 'INR', 'Saudi Riyal', 'Indian Rupee'),
    # European currencies
    ('PLN', 'EUR', 'Polish Zloty', 'Euro'),
    ('CZK', 'EUR', 'Czech Koruna', 'Euro'),
    ('HUF', 'EUR', 'Hungarian Forint', 'Euro'),
    ('SEK', 'EUR', 'Swedish Krona', 'Euro'),
    ('NOK', 'EUR', 'Norwegian Krone', 'Euro'),
